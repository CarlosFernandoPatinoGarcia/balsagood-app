...
public interface PalletVerdeRepository extends JpaRepository<PalletVerde, Integer> {
        ...
        Page<PalletVerde> findByPalletEstado(String palletEstado,
                        Pageable pageable);
        ...
        @Query("SELECT new com.balsagood.balsagood_app.dto.dashboard.RecepcionesMaderaVerdeDTO("
                        +
                        "prov.provNombre, " +
                        "r.numViaje, " +
                        "p.palletNumero, " +
        ...
        List<RecepcionesMaderaVerdeDTO> obtenerReporteRecepciones();
}
